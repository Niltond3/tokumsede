...
export const thisIcons = {
  ...
  AddAress: ({ className, 'aria-label': ariaLabel }: IProps) => (
    <svg
      stroke="currentColor"
      fill="currentColor"
      strokeWidth="0"
