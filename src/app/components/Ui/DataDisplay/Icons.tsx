...
export const thisIcons = {
  Administrator: ({ className }: IProps) => (
    <svg
      stroke="currentColor"
      fill="currentColor"
      strokeWidth="0"
  ...
  NotificationsOff: ({ className }: IProps) => (
    <svg
      stroke="currentColor"
      fill="currentColor"
      strokeWidth="0"
  ...
  NotificationsOn: ({ className }: IProps) => (
    <svg
      stroke="currentColor"
      fill="currentColor"
      strokeWidth="0"
  ...
  Representative: ({ className }: IProps) => (
    <svg
      stroke="currentColor"
      fill="currentColor"
      strokeWidth="0"
