        ...
        <PopoverPrimitive.Portal>
          ...
          >
            ...
            <PopoverPrimitive.Close
              className="absolute right-1 top-1 inline-flex h-5 w-5 items-center justify-center rounded-full text-violet-900 hover:bg-violet-400 focus:shadow-sm focus:shadow-violet-700"
              aria-label="Close"
            >
              x
            </PopoverPrimitive.Close>
...
export const ListboxOptions = React.forwardRef<
  HTMLUListElement,
  types.PopoverOptionsProps
>(({ list }: types.PopoverOptionsProps, ref) => {
  return (
    <Transition
      ref={ref}
      as={Fragment}
                  ...
                  <>
                    <div className="flex ">
                      <div className="relative flex flex-[60%] justify-between">
                        <Icons
                          icon="Info"
                          className="absolute left-2 top-0 h-auto w-5 text-lg-primary"
                        />
                        <div className="relative">
                          <Img image={name as types.ImagePath} blur="blur" />
                          <div
                            className={clsx(
                        ...
                        <Icons
                          icon="AddShopping"
                          className="absolute right-2 top-0 h-auto w-5 text-lg-primary"
                        />
